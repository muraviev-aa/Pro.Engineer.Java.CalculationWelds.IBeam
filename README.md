...
<p align="center">
<img src="images/weld_material.png" alt="drawing" width="650"/>
</p>

* Предусмотрена возможность создания txt файла с результатами расчета. Пример сгенерированного отчета представлен в папке images
  (см. файл result.pdf).
